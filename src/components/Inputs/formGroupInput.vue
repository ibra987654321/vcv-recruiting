<template>
  ...
  >
    ...
    <div :class="[{ 'input-group': hasIcon }]">
      ...
      <slot name="addonLeftPrefix">
        <div v-if="addonLeftPrefix" class="input-group-prepend">
      ...
      <slot>
        <input
          ...
          aria-describedby="addon-right addon-left basic-addon1"
        />
      </slot>
